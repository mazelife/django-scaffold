# -*- coding: utf-8 -*-
#
# django-scaffold documentation build configuration file, created by
...
htmlhelp_basename = 'django-scaffolddoc'
...
latex_documents = [
  ('index', 'django-scaffold.tex', u'django-scaffold Documentation',
